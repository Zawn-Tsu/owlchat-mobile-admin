  ...
  {loading ? (
    ...
    <FlatList
      ...
      contentContainerStyle={[
        ...
        {
          flexGrow: 1,
          paddingBottom: tabBarHeight + 24, // 👈 tăng thêm chút
        }
      ]}
      refreshControl={
        <RefreshControl
          refreshing={refreshing}
          onRefresh={() => { setRefreshing(true); loadChats(0, true); }}
          colors={['#16a34a']}
        />
      }
...
const styles = StyleSheet.create({
  ...
  // 👇 FIX LỖI GIÃN FULL WIDTH
  alignSelf: 'flex-start',
  flexShrink: 0,
  marginRight: 8, // 👈 thay cho gap
  height: 32 
},
  ...
  chatIcon: { width: 40, height: 40, borderRadius: 10, alignItems: 'center', justifyContent: 'center', marginRight: 12 },
...
cardName: {
  ...
  memberBtn: { width: 32, height: 32, borderRadius: 8, backgroundColor: '#f0fdf4', alignItems: 'center', justifyContent: 'center', marginLeft: 8 },
